...
public class OpenSchedule {
    ...
    private void createTables() {
        ...
        this.sqLite.createTable("tbl_user_time", "userTimeId INTEGER NOT NULL", "UserId INTEGER NOT NULL", "UserCode INTEGER NOT NULL", "tiempoInicio DATE DEFAULT CURRENT_TIMESTAMP",
